...
const ServiceCard = ({ index, title, icon}) => {
  return(
    <Tilt className="xs:w-[250px] w-full">
      ...
      className="bg-tertiary surface-elevate rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col"
      >
        <img src={icon} alt={title}
        className="w-16 h-16 object-contain" />
        <h3 className="text-heading text-[20px] font-bold text-center">{title}</h3>
